...
import (
	...
	"github.com/klinova/kinara-os/pharmacy-service/handlers"
...
func main() {
	...
	r.HandleFunc("/ready", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
		w.Write([]byte(`{"status":"ready","service":"pharmacy-service"}`))
	}).Methods(http.MethodGet)
	...
	go func() {
		logger.Info("pharmacy-service starting", "port", port)

...
import (
	...
	"github.com/klinova/kinara-os/vessel-certification-service/auth"
...
func (h *Handler) Register(r *mux.Router, jwtMW func(http.Handler) http.Handler) {
	...
	api.Use(jwtMW)
	api.Use(pkgauth.RequireTenantScope("vessel-certification-service", nil))
	api.HandleFunc("/vessel-certifications", h.list).Methods(http.MethodGet)
	api.HandleFunc("/vessel-certifications", h.create).Methods(http.MethodPost)
	api.HandleFunc("/vessel-certifications/{id}", h.get).Methods(http.MethodGet)
	api.HandleFunc("/vessel-certifications/{id}", h.update).Methods(http.MethodPut)
	api.HandleFunc("/vessel-certifications/{id}", h.delete).Methods(http.MethodDelete)
}

...
const STORIES = [
  ...
  },
  {
    ...
    body: "A container clears customs at the port. A logistics instruction fires inland before the container leaves the dock. No manual handover. No missing shipment. Two ministries coordinated without either seeing the other's data.",
  },
];
          ...
          <div className="relative max-w-[1440px] mx-auto px-8 pt-24 pb-0">
            ...
            <div className="grid md:grid-cols-2 gap-10 mb-16 max-w-5xl">
              <p className="text-[18px] md:text-[20px] text-[#8A98A8] leading-relaxed">
                Kinara OS is the coordination layer that lets health, agriculture, logistics and maritime systems act on the same facts, without any institution surrendering the data it owns.
              </p>
          ...
          <div className="max-w-[1440px] mx-auto reveal">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#C3CEDA] border border-[#C3CEDA]">
              {[
                ...
                { n: "144", l: "databases", sub: "one owner each" },
